...
- Score: -1.5. We used primary net enrollment rather than a broader education measure. This makes the proposition feel more persuasive because primary enrollment is where gender parity looks strongest.
- Score: 1.5. We calculated a female-to-male parity ratio. This directly compares girls and boys and makes a ratio of 1.0 easy to interpret as parity.
...
- Score: -0.5. We used the latest available year for each region. This improves coverage but slightly weakens exact year-to-year comparability.
...
- Score: 1. We shifted from primary enrollment to tertiary enrollment. This challenges the narrow optimism of the first visualization.
